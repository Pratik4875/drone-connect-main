...
import { deleteEvent } from "@/api/user_api"; // Your API function for deletion
...
const DeleteEvent = ({ id }: { id: string }) => {
  ...
  const mutation: UseMutationResult<void, APIError, string> = useMutation({
    ...
    onSuccess: async (data, variables, context) => {
      toast.success("Event deleted successfully!", { id: context.toastId });
...
export default memo(DeleteEvent);
